		...
		<div class="def-temp">
			...
			<center>
				...
				<p style="font: bold 18px georgia; text-transform: uppercase">
					<strong>Payment for your order was successfully processed</strong>
				</p>
				<br/><br/>
			...
			?>
				...
				<br/><br/>
				<p style="font: bold 13px georgia">Thankyou for your shopping with Scarlet</p>
				<br/><br/>
				<p style="font: italic 13px georgia">You can review this order and download your invoice from the "<span style="color: #5b5b5b;">Order history</span>" section of your account by clicking "<a href="<?php echo base_url('secure/my_account');?>" style="color: #5b5b5b;">My account</a>" on our Website</p>
			<?php
				} else {
			?>
				<p style="font: bold 13px georgia">Amount: <?php echo format_currency($this->go_cart->total()); ?></p>
				<br/><br/>
				<p style="font: bold 13px georgia">Please transfer your payment to:
					<br/><br/>
