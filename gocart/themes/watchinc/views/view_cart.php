								...
								<div class="panel-footer" style="background-color: #fff;">
									<div class="row">
										<div class="col-xs-12" style="text-align: right;">
											<a href="../" class="btn btn-orange" style="padding: 6px 30px;">CONTINUE SHOPPING</a>
					...
					<div class="col-sm-5">
						<div class="def-temp">
							<div class="panel panel-as-table" style="margin-top: 20px; border: 1px solid #CCC; border-radius: 0; padding: 30px;">
								<h3 class="title" style="margin-top: 0; margin-bottom: 20px;"><span class="orange">HAVE</span> A COUPON?</h3>
